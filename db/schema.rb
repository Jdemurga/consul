...
ActiveRecord::Schema.define(version: 20191108173350) do
  ...
  create_table "budget_investments", force: :cascade do |t|
    t.integer  "author_id"
    t.integer  "administrator_id"
    t.string   "deprecated_title",                 limit: 180
    ...
    t.index ["unified_with_id"], name: "index_budget_investments_on_unified_with_id", using: :btree
  end
  ...
  create_table "commissions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["geozone_id"], name: "index_commissions_on_geozone_id", using: :btree
  end
  ...
  create_table "consul_assemblies_assemblies", force: :cascade do |t|
    ...
    t.index ["geozone_id"], name: "index_consul_assemblies_assemblies_on_geozone_id", using: :btree
  end
  ...
  create_table "consul_assemblies_meetings", force: :cascade do |t|
    ...
    t.index ["assembly_id"], name: "index_consul_assemblies_meetings_on_assembly_id", using: :btree
  end
  ...
  create_table "consul_assemblies_proposals", force: :cascade do |t|
    ...
    t.index ["meeting_id"], name: "index_consul_assemblies_proposals_on_meeting_id", using: :btree
  end
  ...
  create_table "present", id: false, force: :cascade do |t|
    t.bigint "count"
  end
  ...
  create_table "sms_otps", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["phone_number"], name: "index_sms_otps_on_phone_number", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["commission_id"], name: "index_users_on_commission_id", using: :btree
